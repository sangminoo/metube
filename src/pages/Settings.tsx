            ...
            <div>
              <CropImageModal
                channel={{
                  ...
                  name: channel.name ?? channel.email ?? "",
                }}
                refetch={refetch}
                  ...
                  <div className="px-4 py-6 sm:p-8">
                    <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                      <div className="sm:col-span-4">
                        ...
                        <div className="mt-2">
                          <div className="focus-within:ring-primary-600 flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset sm:max-w-md">
          ...
          <label htmlFor="file-upload-image" className="cursor-pointer">
              {channel?.image ? (
                <>
                  ...
                  <Image
                    className="h-24 w-24 rounded-full ring-4 ring-white sm:h-32 sm:w-32 hover:opacity-70"
                    width="2000"
                    height="2000"
                    src={channel?.image ?? "/profile.jpg"}
                    alt="No image or error"
                  />
                </>
              ) : (
                <>
                  <input
                    ...
                    onChange={onFileChange}
                  />
                  <div className="flex h-24  w-24 cursor-pointer items-center justify-center rounded-full bg-black object-cover text-6xl font-semibold uppercase text-white ring-4 ring-white hover:opacity-70 sm:h-32 sm:w-32 ">
        ...
        <>
          <label htmlFor="file-upload-backgroundImage">
            ...
            {channel.backgroundImage ? (
              <Image
                className="h-32 w-full object-cover lg:h-64 hover:opacity-70 cursor-pointer rounded-lg "
              ...
              <>
                <div className="relative h-60  w-full rounded-md bg-transparent object-cover ">
                  <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-gradient-to-r from-gray-50 via-gray-100 to-gray-50 opacity-0 transition duration-300 ease-in-out hover:opacity-70"></div>
                </div>
              </>
            )}
          </label>
