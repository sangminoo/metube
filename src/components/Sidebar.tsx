...
const Sidebar = ({ setSidebarOpen, isOpen, closeSidebar }: SidebarProps) => {
  ...
  return (
    <>
      {isOpen && !isTablet && (
        <div
          className={cn(
            ...
            closeSidebar ? "lg:w-[70px]" : "lg:w-60",
          )}
        >
      ...
      // Sidebar mobile
      <Transition.Root show={isTablet ? isOpen : false} as={Fragment}>
        <Dialog className="relative z-50 xl:hidden h-full" onClose={setSidebarOpen}>
          <Transition.Child
              as={Fragment}
          ...
          <div className="fixed inset-0 h-full ">
            ...
            >
              <Dialog.Panel className="w-full h-full max-w-[240px] transform rounded-none bg-white p-0 text-left align-middle shadow-xl transition-all">
                <div className="flex items-center justify-start mx-4  bg-white max-w-[240px] z-50 ">
                  {/* menu */}
                  <button
                    className={`${
                      isMobile ? "hidden" : ""
                ...
                <div className="h-full scrollbarBase flex grow flex-col  gap-y-5   overflow-y-auto  bg-white  ">
                  <nav className="my-3 flex flex-col    ">
                    <ul role="list" className="flex flex-1 flex-col   ">
                      <li className="mt-auto">
                        <ul role="list" className="">
