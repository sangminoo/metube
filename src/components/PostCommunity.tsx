      ...
      <div className="relative w-[32rem]">
        ...
        <div className="flex w-full justify-between py-1.5">
          ...
          <div className="flex gap-2">
            ...
            <button
              className="select-none rounded-md bg-gray-900 px-4 py-2 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
              type="button"
            >
              Post Comment
            </button>
